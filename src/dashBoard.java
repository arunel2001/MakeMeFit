...
public class dashBoard {
     ...
     */
    public void calorieTracker(String userName) {
        ...
        if (choice == 5) {
            ...
            settingsObj.settingOptions(userName);
        } else {
    ...
    public int writingCalorieData(String currentUserName,int newUserFlag){            //storing data into the file
        File dayFile = new File("D:\\Fit\\"+currentUserName+".txt");
        if(newUserFlag==1){
            try {
    ...
    public void writingDayWise(String userName,int day){
        File dayWiseFile = new File("D:\\Fit\\Daywise\\"+userName+".txt");
        try{
